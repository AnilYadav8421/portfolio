...
const projects = [
    {
        ...
        description:
            "Full-featured e-commerce platform with  with product browsing, filtering, sorting, and cart management.",
    ...
    },
    {
        ...
        description:
            "A responsive website with smooth animations, dynamic UI components, and a contact form integrated.",
